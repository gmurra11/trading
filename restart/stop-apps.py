...
options_ivp = "options-high-iv-search/ivp.py"
options_skew_dashboard_script = "option-skew-dashboard/skew-dashboard.py"

# Create a list of the scripts
scripts = [options_liquidity_eth, options_liquidity_eth_blocked, options_liquidity_btc, options_liquidity_btc_blocked, options_ivp, options_skew_dashboard_script]
