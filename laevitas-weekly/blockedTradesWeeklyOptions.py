...
FOLLOWING_FRIDAY_LVT_WEEKLY_CSV_FILE = f"{DIR}/LVT-WEEKLY-3MAR23.csv"
FOLLOWING_FRIDAY_LVT_MONTHLY_CSV_FILE = f"{DIR}/LVT-MONTHLY-3MAR23.csv"
...
FOLLOWING_FRIDAY_LVT_WEEKLY_CSV_FILE_T1 = f"{T1}/LVT-WEEKLY-3MAR23.csv"
FOLLOWING_FRIDAY_LVT_MONTHLY_CSV_FILE_T1 = f"{T1}/LVT-MONTHLY-3MAR23.csv"
...
FOLLOWING_FRIDAY_LVT_WEEKLY_CSV_FILE_T7 = f"{T7}/LVT-WEEKLY-3MAR23.csv"
FOLLOWING_FRIDAY_LVT_MONTHLY_CSV_FILE_T7 = f"{T7}/LVT-MONTHLY-3MAR23.csv"
