...
from ivp import get_options_table
...
less_than_50_days_call_table = get_options_table("C", CURRENCY, 50, 80, MIN_STRIKE, MAX_STRIKE, LESS_THAN_50_DAYS_WEEKLY_CSV_FILE, LESS_THAN_50_DAYS_MONTHLY_CSV_FILE, LESS_THAN_50_DAYS_WEEKLY_CSV_FILE_T1, LESS_THAN_50_DAYS_MONTHLY_CSV_FILE_T1, LESS_THAN_50_DAYS_WEEKLY_CSV_FILE_T7, LESS_THAN_50_DAYS_MONTHLY_CSV_FILE_T7)
less_than_50_days_put_table = get_options_table("P", CURRENCY, 50, 80, MIN_STRIKE, MAX_STRIKE, LESS_THAN_50_DAYS_WEEKLY_CSV_FILE, LESS_THAN_50_DAYS_MONTHLY_CSV_FILE, LESS_THAN_50_DAYS_WEEKLY_CSV_FILE_T1, LESS_THAN_50_DAYS_MONTHLY_CSV_FILE_T1, LESS_THAN_50_DAYS_WEEKLY_CSV_FILE_T7, LESS_THAN_50_DAYS_MONTHLY_CSV_FILE_T7)
less_than_80_days_call_table = get_options_table("C", CURRENCY, 50, 80, MIN_STRIKE, MAX_STRIKE, LESS_THAN_80_DAYS_WEEKLY_CSV_FILE, LESS_THAN_80_DAYS_MONTHLY_CSV_FILE, LESS_THAN_80_DAYS_WEEKLY_CSV_FILE_T1, LESS_THAN_80_DAYS_MONTHLY_CSV_FILE_T1, LESS_THAN_80_DAYS_WEEKLY_CSV_FILE_T7, LESS_THAN_80_DAYS_MONTHLY_CSV_FILE_T7)
