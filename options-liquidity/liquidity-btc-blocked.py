...
less_than_50_days_call_table = get_options_table("C", CURRENCY, 25, 50, MIN_STRIKE, MAX_STRIKE, LESS_THAN_50_DAYS_WEEKLY_CSV_FILE, LESS_THAN_50_DAYS_MONTHLY_CSV_FILE, LESS_THAN_50_DAYS_WEEKLY_CSV_FILE_T1, LESS_THAN_50_DAYS_MONTHLY_CSV_FILE_T1, LESS_THAN_50_DAYS_WEEKLY_CSV_FILE_T7, LESS_THAN_50_DAYS_MONTHLY_CSV_FILE_T7, is_blocked)
less_than_50_days_put_table = get_options_table("P", CURRENCY, 25, 50, MIN_STRIKE, MAX_STRIKE, LESS_THAN_50_DAYS_WEEKLY_CSV_FILE, LESS_THAN_50_DAYS_MONTHLY_CSV_FILE, LESS_THAN_50_DAYS_WEEKLY_CSV_FILE_T1, LESS_THAN_50_DAYS_MONTHLY_CSV_FILE_T1, LESS_THAN_50_DAYS_WEEKLY_CSV_FILE_T7, LESS_THAN_50_DAYS_MONTHLY_CSV_FILE_T7, is_blocked)
...
@app.route('/liquidity-btc-blocked')
def push_web():
